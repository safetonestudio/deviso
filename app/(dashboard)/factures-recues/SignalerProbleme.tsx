...
export function SignalerProbleme({
  ...
  const declencheur = (
    <button
      ...
      className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-amber-500/40 text-amber-400 text-sm font-semibold hover:bg-amber-500/10 transition-colors whitespace-nowrap"
    >
