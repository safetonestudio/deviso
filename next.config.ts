...
const securityHeaders = [
  ...
  // 'unsafe-eval' requis pour @react-pdf/renderer
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://cdn.crisp.chat https://client.crisp.chat https://image.crisp.chat https://storage.crisp.chat",
      "font-src 'self' data: https://client.crisp.chat",
      "connect-src 'self' https://*.supabase.co https://api.stripe.com https://client.crisp.chat wss://client.relay.crisp.chat https://storage.crisp.chat https://image.crisp.chat https://api.resend.com https://*.ingest.de.sentry.io https://*.ingest.sentry.io",
